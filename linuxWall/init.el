;; Emacs conf file - Nabil - Linux version - Behind the Wall!! 
...
(add-to-list 'load-path "/home/rlas/.emacs.d/packages/doom-modeline-master")
(add-to-list 'load-path "/home/rlas/.emacs.d/packages/themes-master")
(add-to-list 'load-path "/home/rlas/.emacs.d/packages/dash.el-master")
(add-to-list 'load-path "/home/rlas/.emacs.d/packages/all-the-icons.el-master")
(add-to-list 'load-path "/home/rlas/.emacs.d/packages/shrink-path.el-master")
(add-to-list 'load-path "/home/rlas/.emacs.d/packages/s.el-master")
(add-to-list 'load-path "/home/rlas/.emacs.d/packages/f.el-master")
(require 'doom-themes)
...
;; autocomplete
(add-to-list 'load-path "/home/rlas/.emacs.d/packages/auto-complete")
(add-to-list 'load-path "/home/rlas/.emacs.d/packages/popup-el-master")
...
;; which-key
(add-to-list 'load-path "/home/rlas/.emacs.d/packages/which-key")
(require 'which-key)
(which-key-mode)

;; beacon
(add-to-list 'load-path "/home/rlas/.emacs.d/packages/beacon")
(require 'beacon)
(beacon-mode)

;; Ace-window
(add-to-list 'load-path "/home/rlas/.emacs.d/packages/ace-window-master")
(add-to-list 'load-path "/home/rlas/.emacs.d/packages/avy-master")
(require 'ace-window)
...
;;ivy mode
(add-to-list 'load-path "/home/rlas/.emacs.d/packages/swiper-master")
(require 'ivy)
(require 'swiper)
(require 'counsel)
(ivy-mode 1)
...
;; Icicles
(add-to-list 'load-path "~/.emacs.d/packages/icicles-master")
(require 'icicles)
(icy-mode 1)
...
;; nerd icons
(add-to-list 'load-path "~/.emacs.d/packages/nerd-icons.el")
(require 'nerd-icons)
(insert (nerd-icons-icon-for-file "init.el"))
;; Insert an icon for Emacs Lisp
...
;; '(default ((t (:family "Liberation Mono" :foundry "1ASC" :slant normal :weight normal :height 140 :width normal)))))
